...
public:
    ...
    /* Added */
    void                 set_src_id(const unsigned int id){ m_s_id = id; }
    unsigned int         get_src_id() const { return m_s_id; }
    
    void                 set_dst_id(const unsigned int id){ m_d_id = id; }
    unsigned int         get_dst_id() const { return m_d_id; }
    
    void                 set_layer(const std::string layer){ m_layer = layer; }
    std::string          get_layer() const { return m_layer; }

    void                 set_bst_size(const unsigned int size){ m_bst_size = size; }
    unsigned int         get_bst_size() const { return m_bst_size; }

    void                 set_bst_id(const unsigned int id){ m_bst_id = id; }
    unsigned int         get_bst_id() const { return m_bst_id; }    

    void                 set_head(const bool b) { is_head_payload = b; }
    bool                 get_head() const { return is_head_payload; }

    void                 set_pim_cmd(const std::string cmd){ m_cmd = cmd; }
    std::string          get_pim_cmd() const { return m_cmd; }

    void                 set_last(const bool b) { is_last_payload = b; }
    bool                 is_last() const { return is_last_payload; }
...
private:
    ...
    unsigned int         m_s_id;
    unsigned int         m_d_id;
    unsigned int         m_bst_id;
    unsigned int         m_bst_size;
    bool                 is_head_payload = false;
    bool                 is_last_payload = false;
    std::string          m_layer = "";
    std::string          m_cmd;
