...
GEMMA_PIM_OFFLOAD_MAP = {
    ...
    ('partitioned', 4): [ # Speculative decoding (draft model)
        'D_K0', 'D_Q0', 'D_Q1', 'D_V0',
        'D_K2', 'D_Q2', 'D_Q3', 'D_V2',
        'D_K4', 'D_Q4', 'D_Q5', 'D_V4',
        'D_K6', 'D_Q6', 'D_Q7', 'D_V6',
    ...
    ('unified', 4): [ # Speculative decoding (draft model)
        'D_K0', 'D_Q0', 'D_Q1', 'D_V0',
        'D_K2', 'D_Q2', 'D_Q3', 'D_V2',
        'D_K4', 'D_Q4', 'D_Q5', 'D_V4',
        'D_K6', 'D_Q6', 'D_Q7', 'D_V6',
...
def _resolve_pim_offload_list(memory_structure, scenario_id):
    ...
    key = (memory, scenario)
    if key in GEMMA_PIM_OFFLOAD_MAP:
        return GEMMA_PIM_OFFLOAD_MAP[key]
