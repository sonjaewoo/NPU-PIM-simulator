...
def Gemma9bLayer(
    ...
    mb = ModelBuilder(f'Gemma9b_layer')
...
GEMMA9B_PIM_OFFLOAD_MAP = {
    ('partitioned', 1): [ # Concurrency-driven
        ...
        'D_K8_RoPE', 'D_Q8_RoPE', 'D_Q9_RoPE',
        'D_K10_RoPE', 'D_Q10_RoPE', 'D_Q11_RoPE',
        'D_K12_RoPE', 'D_Q12_RoPE', 'D_Q13_RoPE',
        'D_K14_RoPE', 'D_Q14_RoPE', 'D_Q15_RoPE',
        'D_QK_T4', 'D_QK_T5',
        'D_QK_T6', 'D_QK_T7',
        'D_QK_T8', 'D_QK_T9',
        'D_QK_T10', 'D_QK_T11',
...
def _resolve_pim_offload_list(memory_structure, scenario_id):
    ...
    key = (memory, scenario)
    if key in GEMMA9B_PIM_OFFLOAD_MAP:
        return GEMMA9B_PIM_OFFLOAD_MAP[key]
...
def Gemma9bLayer_pim_offload(
    ...
    mb = Gemma9bLayer(input_len=input_len, input_pos=input_pos, hidden_size=hidden_size, intermediate_size=intermediate_size, num_attention_heads=num_attention_heads, num_key_value_heads=num_key_value_heads, head_dim=head_dim, max_seq_len=max_seq_len)
