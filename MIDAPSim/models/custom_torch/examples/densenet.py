# This code is based on https://github.com/osmr/imgclsmob/tree/master/pytorch/pytorchcv/models
#
# This project incorporates material from the project listed above, and it
# is accessible under their original license terms (MIT License)
...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        self.features.add_module(
            "init_block",
            PreResInitBlock(in_channels=in_channels, out_channels=init_block_channels),
        )
