...
def efficientnet_effunet(net='efficietnet-b0', input_channels=None):
    ...
    res = mb.Conv(x, input_shape[1], scaled_first_filters, 1, 1, 'same')
    encoder_out = []
    for block_args in blocks_args:
        assert block_args.num_repeat > 0

        res = add_mbconv_block(mb, res, block_args)
        add_flag = block_args.strides[0] != 1
        ...
        for _ in range(block_args.num_repeat - 1):
            res = add_mbconv_block(mb, res, block_args)
        if add_flag:
            encoder_out.append((res, block_args.output_filters))

    return mb, encoder_out[::-1]
...
def get_base_args_params(net):
    effnet_b0_blocks_args = [
        'r1_k3_s11_e1_i32_o16_se0.25', 'r2_k3_s22_e5_i16_o24_se0.25',
        'r2_k5_s22_e5_i24_o40_se0.25', 'r3_k3_s22_e5_i40_o80_se0.25',
        'r3_k5_s11_e5_i80_o112_se0.25', 'r4_k5_s22_e5_i112_o192_se0.25',
        'r1_k3_s11_e5_i192_o320_se0.25',
    ]
