...
def inception_v3(input_size=299, num_classes=1000, softmax=False):
    ...
    Mixed_5d = inception_a(mb, Mixed_5c, 288, pool_features=96)
    Mixed_6a = inception_b(mb, Mixed_5d, 320)
    Mixed_6b = inception_c(mb, Mixed_6a, 800, channels_7x7=128)
...
def inception_a(mb, x, in_channels, pool_features):
    ...
    output = mb.Concat([branch_pool, branch1x1, branch5x5, branch3x3dbl])
    return output
...
def inception_b(mb, x, in_channels):
    ...
    output = mb.Concat([branch_pool, branch3x3, branch3x3dbl])
    return output
...
def inception_e(mb, x, in_channels):
    ...
    output = mb.Concat([branch_pool, branch1x1, branch3x3a, branch3x3b,
