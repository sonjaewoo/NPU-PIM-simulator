...
std::deque<std::shared_ptr<TraceGenerator::Trace>>& generate_gemma_s1_p(TraceGenerator& gen)
{
    ...
    gen.add_rope_trace("D_K2_RoPE", pim_rope_cmds);
    gen.add_rope_trace("D_Q3_RoPE", pim_rope_cmds);
    ...
    gen.add_host_trace("Softmax_D_H3", {PIM}, {DRAM});
    gen.add_host_trace("Softmax_D_H4", {PIM}, {DRAM});
    gen.add_host_trace("Softmax_D_H5", {PIM}, {DRAM});
    ...
    gen.add_host_trace("Softmax_D_H6", {PIM}, {DRAM});
    gen.add_host_trace("Softmax_D_H7", {PIM}, {DRAM});
