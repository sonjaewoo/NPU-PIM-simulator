...
std::deque<std::shared_ptr<TraceGenerator::Trace>>& generate_gemma_s4_p(TraceGenerator& gen)
{
    ...
    gen.add_rope_trace("D_Q1_RoPE", pim_rope_cmds);

    gen.add_rope_trace("D_K2_RoPE", pim_rope_cmds);
    gen.add_rope_trace("D_Q2_RoPE", pim_rope_cmds);
