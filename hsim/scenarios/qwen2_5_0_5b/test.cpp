...
std::deque<std::shared_ptr<TraceGenerator::Trace>>& generate_qwen_test(TraceGenerator& gen)
{
    ...
    gen.add_gemv_trace("D_K7", pim_linear_cmds, PIM);
    ...
    gen.add_gemv_trace("D_V7", pim_linear_cmds, PIM);

    gen.add_gemv_trace("D_K0_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q0_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q1_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q2_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q3_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q4_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q5_RoPE", pim_rope_cmds, PIM);    
    gen.add_gemv_trace("D_Q6_RoPE", pim_rope_cmds, PIM);

    gen.add_gemv_trace("D_K7_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q7_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q8_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q9_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q10_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q11_RoPE", pim_rope_cmds, PIM);
    gen.add_gemv_trace("D_Q12_RoPE", pim_rope_cmds, PIM);    
    gen.add_gemv_trace("D_Q13_RoPE", pim_rope_cmds, PIM);


    for (int i = 0; i < 14; i++)
        gen.add_gemv_trace("D_QK_T" + std::to_string(i), pim_linear_cmds, PIM);
    
    for (int i = 0; i < 14; i++)
        gen.add_host_trace("Softmax_D_H" + std::to_string(i), {PIM}, {PIM});

    for (int i = 0; i < 14; i++)
        gen.add_gemv_trace("D_S_V" + std::to_string(i), pim_linear_cmds, PIM);
