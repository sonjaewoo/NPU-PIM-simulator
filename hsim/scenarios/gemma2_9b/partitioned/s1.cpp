...
std::deque<std::shared_ptr<TraceGenerator::Trace>>& generate_gemma_9b_s1_p(TraceGenerator& gen)
{
    ...
    gen.add_host_trace("Softmax_D_H8", {PIM}, {DRAM});
    gen.add_host_trace("Softmax_D_H9", {PIM}, {DRAM});
