...
std::deque<std::shared_ptr<TraceGenerator::Trace>>& generate_qwen_7b_s1_p(TraceGenerator& gen)
{
    ...
    gen.add_rope_trace("D_K16_RoPE", pim_rope_cmds);
    ...
    gen.add_rope_trace("D_K20_RoPE", pim_rope_cmds);
    ...
    gen.add_rope_trace("D_K24_RoPE", pim_rope_cmds);
    gen.add_rope_trace("D_Q24_RoPE", pim_rope_cmds);
    gen.add_rope_trace("D_Q25_RoPE", pim_rope_cmds);
    gen.add_rope_trace("D_Q26_RoPE", pim_rope_cmds);    
    gen.add_rope_trace("D_Q27_RoPE", pim_rope_cmds);
    ...
    gen.add_gemv_trace("D_QK_T24", pim_linear_cmds, PIM);
    gen.add_gemv_trace("D_QK_T25", pim_linear_cmds, PIM);
    gen.add_gemv_trace("D_QK_T26", pim_linear_cmds, PIM);
    gen.add_gemv_trace("D_QK_T27", pim_linear_cmds, PIM);
    ...
    gen.add_host_trace("Softmax_D_H24", {PIM}, {DRAM});
    gen.add_host_trace("Softmax_D_H25", {PIM}, {DRAM});
    gen.add_host_trace("Softmax_D_H26", {PIM}, {DRAM}); 
    gen.add_host_trace("Softmax_D_H27", {PIM}, {DRAM});
