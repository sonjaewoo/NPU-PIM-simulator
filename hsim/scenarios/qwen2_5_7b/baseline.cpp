...
std::deque<std::shared_ptr<TraceGenerator::Trace>>& generate_qwen_7b_baseline(TraceGenerator& gen)
{
    ...
    gen.add_host_trace("Softmax_D_H24", {DRAM}, {DRAM});
    gen.add_host_trace("Softmax_D_H25", {DRAM}, {DRAM});
    gen.add_host_trace("Softmax_D_H26", {DRAM}, {DRAM}); 
    gen.add_host_trace("Softmax_D_H27", {DRAM}, {DRAM});
